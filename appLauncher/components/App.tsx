...
export default function App({ app, onOpen }: Props) {
    ...
    return (
        <box orientation={Gtk.Orientation.HORIZONTAL} class="app-container">
            ...
            <box orientation={Gtk.Orientation.VERTICAL} class="app-details" valign={Gtk.Align.CENTER}>
                <label label={app.name} class="app-name" halign={Gtk.Align.START} />

                {app.description && <label label={app.description} class="app-description" halign={Gtk.Align.START} />}
            </box>
        </box>
    )
}